...
## Senior Front-end Engineer & UI Specialist
...
- ⚡ **Frontend Architecture**: Building robust, scalable web applications using React, Next.js, Vue.js, and Nuxt.
- 🎨 **UI/UX & Design Systems**: Crafting polished, responsive interfaces, micro-interactions, and enterprise component libraries.
- 💨 **Web Performance**: Fine-tuning application speed, Core Web Vitals, accessibility (a11y), and modern frontend tooling.
- 🤖 **AI Tooling & Automation**: Integrating AI LLMs (Google Gemini, OpenAI) and creating developer productivity workflows.
